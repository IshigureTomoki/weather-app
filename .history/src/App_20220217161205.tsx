  ...
  const wetherOneCall = async () => {
    await axios
      ...
      .then((res) => {
        ...
        const date_and_Time=(time:number)=>{
          const srTime = new Date(time * 1000);

...
function App() {
  ...
  const openStreetMap = async()=>{
    await axios.get(`https://nominatim.openstreetmap.org/reverse?format=json&lat=35.681111&lon=139.766667&zoom=18&addressdetails=1`).then((res)=>{console.log(res)}).catch((err) => {
      alert(err.message);
      console.log(err);
    });

...
export const LinePlot = () => {
  ...
  return (
    ...
    <ComposedChart width={650} height={300} data={data}>
      ...
      <Line yAxisId={1} type="monotone" dataKey="temp" stroke="#ff7300" label={{ fill: 'white', fontSize: 15 }} />
      <CartesianGrid stroke="#ccc" />
      <XAxis dataKey="time" />
      <YAxis yAxisId={1} tickCount={8} unit="℃" label={{ value: "気温"}}/>
      <YAxis yAxisId={2} tickCount={8} unit="%"  label={{ value: "降水確率", dx: 5 }} orientation="right"/>
      <Tooltip />
    </ComposedChart>
    </ResponsiveContainer>
  );
